...
"""
How to strip whitespace from strings in Python from right side
"""
...
print("\nStripping whitespace from all names from right side")

#Use the rstrip() method to strip whitespace from all names from right side
